...
VALUES(1, 'Procesador Intel Core i9-10900K', 'Procesador', 499.99, 0, NULL, NULL, 5, 10, 'Intel Corporation', 'Procesador de alto rendimiento para ordenadores de sobremesa.');

INSERT INTO producte(id, nom, tipus, preu, descompte, dataIniciOferta, dataFiOferta, estoc, estocMinim, proveidor, descripcio) 
VALUES(2, 'Tarjeta gráfica NVIDIA GeForce RTX 3080', 'Tarjeta gráfica', 799.99, 0, NULL, NULL, 2, 5, 'NVIDIA Corporation', 'Tarjeta gráfica de última generación para juegos y diseño.');

INSERT INTO producte(id, nom, tipus, preu, descompte, dataIniciOferta, dataFiOferta, estoc, estocMinim, proveidor, descripcio) 
VALUES(3, 'Placa base ASUS ROG Strix Z590-E Gaming', 'Placa base', 349.99, 10, TO_DATE('2024-05-07', 'YYYY-MM-DD'), TO_DATE('2024-05-14', 'YYYY-MM-DD'), 1, 5, 'ASUSTeK Computer Inc.', 'Placa base de alta gama para procesadores Intel de 10ª y 11ª generación.');
